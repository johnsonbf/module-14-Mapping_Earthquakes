...
// We create the tile layer that will be the background of our map.navigationMap
...
// We create the second tile layer that will be the satellite streets view.
...
// We create the third tile layer that will be the extra option on the map
...
function getMajorRadius(magnitude) {
  ...
  return magnitude * 3;
    ...
    // Pass the major quake data to the geoJSON() layer
    L.geoJson(data, {
...
let plateStyle = {
  ...
  L.geoJSON(data, {
    style: plateStyle,
    onEachFeature: function(feature, layer) {
      layer.bindPopup("Tectonic Plate:" + feature.properties.PlateName)}
  }).addTo(tectPlates);
